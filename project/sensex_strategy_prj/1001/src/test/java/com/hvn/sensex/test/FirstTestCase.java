...
public class FirstTestCase {
	...
	public void testMinMaxCurrent() throws Exception {
		List<ScriptHighLowCurrent> highLowCurrents = MarketHelper.getHighLowsCurrentList(Utils.parseDay("2021-03-05"), Utils.parseDay("2022-04-05"));
	...
	public void testCurrent() throws Exception {
		DayValue tcsValue = MarketHelper.getValue("Tata Consultancy Services Ltd.",  Utils.parseDay("2021-04-03"));
		System.out.println("TCSValue = " + tcsValue.value);
	...
	public void testCalculateIRR() {
		...
		investments.add(new InvestmentEvent(200, Utils.parseDay("2016-04-01")));
		investments.add(new InvestmentEvent(300, Utils.parseDay("2014-04-01")));
		
		double irr = InvestmentEvent.calculateIRR(investments, Utils.parseDay("2022-04-01"), 2000, 1.1, 2.0, 0.0005);
		System.out.println("IRR = " + irr);
	}
	
	@Test
	public void testIndexValues() {
		System.out.println(MarketHelper.getIndexValue(Utils.parseDay("2022-04-01")));
